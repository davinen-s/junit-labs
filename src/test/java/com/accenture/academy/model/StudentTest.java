...
public class StudentTest {
	...
	public void testAssertNotEquals() {
		...
		assertNotEquals("student should not be aggresive.","Aggressive", studentAnna.getAttitude());
	}
	

	/**
	 * Example of assertTrue. We are verifying that by default a 'Student' object has 
	 * 'acnAcademyStudent' attribute defaulted to true.
	 */
	@Test
	...
	/**
	 * Example of assertFalse. We are verifying that by default a 'Student' object has 
	 * 'funny' attribute defaulted to false.
	 * Best business case example is a tuitionFeePayment attribute/field.
	 */
	@Test
	public void testAssertFalse() {
		...
		assertFalse("Anna should not be funny. value must be false", studentAnna.isFunny());
	}
	

	/**
	 * Example of assertNotNull. We are verifying that the value of the 'firstName' field
	 * is not null.
	 */
	@Test
	...
	public void testAssertSame() {
		...
		assertSame("Anna and John are two different persons. They cannot be the same",
				studentAnna, studentJohn);
	...
	public void testAssertNotSame() {
		...
		assertNotSame("Anna and John are two different persons. They cannot be the same",
				studentAnna, studentJohn);
