...
public class UniversityServiceTest {
	...
	public void setUpStudent() {
		student = UniversityService.registerStudent("Manu", "Seenundun", LocalDate.of(1994, 5, 23), true);
	}
	...
	public void testToCheckStudentParametersAreNotNull() {
		...
		assertEquals("Manu", student.getFirstName());
		assertEquals("Seenundun", student.getLastName());
		assertEquals("1994-05-23", student.getDob().toString());
