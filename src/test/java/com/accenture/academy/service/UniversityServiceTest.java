...
public class UniversityServiceTest {
	...
	public void testRegisterStudentFieldValues() {
		Student s = UniversityService.registerStudent("audrey", "sing", LocalDate.of(1995, 5, 5), false);

		assertNotNull(s);
		assertNotNull(s.getId());
		assertEquals("audrey", s.getFirstName());
		assertEquals("sing", s.getLastName());
		assertEquals("1995-05-05", s.getDob().toString());
	...
	public void testEnrollModulesWhenStudentIsAcademicStudent() {
		Student s = UniversityService.registerStudent("audrey", "sing", LocalDate.of(1995, 5, 5), true);
